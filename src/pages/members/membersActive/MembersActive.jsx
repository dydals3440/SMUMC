          ...
          (item, index) =>
            (item.position === '회장' || item.position === '부회장') && (
              <MemberCard
                ...
                name={item.name}
                badge={item.position}
                imgurl='https://images.unsplash.com/photo-1682687220866-c856f566f1bd?w=700&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDF8MHxlZGl0b3JpYWwtZmVlZHw2fHx8ZW58MHx8fHx8'
              />
            )
        )}
      </S.MemberContainer>
